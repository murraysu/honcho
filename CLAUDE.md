...
This project is indexed by GitNexus as **honcho** (13924 symbols, 25278 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
